...
from PAF import PAF, PairTrainSampler, PairTestSampler
...
def parse_datasets(args, device):
	...
	if dataset_name == "PAF":
		...
		train_sampler = PairTrainSampler(train_data, batch_size=batch_size)
		test_sampler = PairTestSampler(test_data, batch_size=batch_size)
